...
if __name__ =="__main__":
	...
	codexsexp = build_data(name = 'codexs',path = tools.cur_path + '/datasets/')


	#SGD hyper-parameters:
	params = Parameters(learning_rate = 0.5, 
						max_iter = 1000, 
						batch_size = int(len(codexsexp.train.values) / 100),  #Make 100 batches
						neg_ratio = 10, 
	...
	codexsexp.grid_search_on_all_models(all_params, embedding_size_grid = [emb_size], lmbda_grid = [lmbda], nb_runs = 1)


	#Print best averaged metrics:
	codexsexp.print_best_MRR_and_hits()
